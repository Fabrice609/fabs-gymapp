...
export default function ExerciseCard(props) {
  ...
  return (
    //took out the sm:flex-wrap for now
    <div className='flex flex-col p-4 rounded-md gap-4 bg-slate-900'>
        ...
        <div className='flex flex-col bg-slate-800 rounded gap-2 p-2'>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-4 sm:palce-items-center gap-3'>
